...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/11 01:14:40 by mabbas            #+#    #+#             */
/*   Updated: 2023/07/11 01:34:29 by mabbas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* virtual means the the linkage will be dynamic not static 
    ...
    A virtual member function is is summoned a method.
...
int main( void )
{
    ...
    std::cout << "PET Type: " << pet1->getType() << " " << std::endl;
    std::cout << "PET Type: " << pet2->getType() << " " << std::endl;
    pet1->makeSound();
    //pet2->makeSound();
    meta->makeSound();
