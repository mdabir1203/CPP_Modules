...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/11 01:18:51 by mabbas            #+#    #+#             */
...
public:
    ...
    /*
        ...
        destructor will be is summoned at run time, but it is summoned the derived class first
        and then base class to release the space occupied by both destructors.

        Every destructor down gets is summoned no matter what. virtual makes sure it
